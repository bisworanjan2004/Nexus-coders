  ...
  const services = [
    {
      ...
      description:
        "Custom websites built with modern technologies that are fast, responsive, and SEO-friendly.",
      features: [
    ...
    },
    {
      ...
      description:
        "Robust and scalable APIs to power your applications and connect your services.",
      features: [
        "RESTful API design",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground">
              We offer a comprehensive range of development services to help
          ...
          dark:after:from-primary/20 dark:after:to-secondary/20"
            ...
            hover:bg-blue-700 hover:text-white border-sky-400 hover:border-none "
                ...
                <div className="absolute inset-0 overflow-hidden opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div
                    className="absolute -inset-8 bg-gradient-to-r from-primary/30 to-secondary/30 
            dark:from-primary/40 dark:to-secondary/40 
            blur-xl group-hover:animate-pulse-slow"
                  ></div>
                </div>
              </Card>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Understanding your requirements, goals, and target audience to
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Creating a detailed roadmap with timelines, milestones, and
                deliverables.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Building your solution with clean, efficient code and regular
                progress updates.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Thorough testing, deployment, and post-launch support to ensure
            ...
            <Card className="border hover:border-sky-400 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] group cursor-pointer">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  could take 2-3 months. We'll provide a detailed timeline
            ...
            <Card className="border hover:border-sky-400 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] group cursor-pointer">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  remaining 50% due upon project completion. For larger
                  projects, we offer milestone-based payment schedules.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border hover:border-sky-400 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] group cursor-pointer">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  website running smoothly. This includes regular updates,
                  security monitoring, and content updates.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border hover:border-sky-400 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] group cursor-pointer">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  Next.js, Node.js, and various databases both SQL and NoSQL. We
